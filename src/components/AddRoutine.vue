...
<style scoped>
.card {
  @apply bg-white text-black rounded-2xl flex flex-col text-lg;
}
.card {
  height: 400px;
}
header {
  @apply w-full h-1/4 bg-orange rounded-t-2xl;
}
header > img {
  @apply w-14 h-14;
}
.form {
  @apply p-3 space-y-3 flex flex-col;
}
.form > input {
  @apply w-72 h-12 border-black border-2 rounded-2xl p-3 self-center;
}
.form > h1 {
  @apply text-center font-bold text-2xl;
}
.options {
  @apply text-orange cursor-pointer space-x-10 p-5;
}
</style>
